...
import type { User } from './User/page';




const ExistingMembersPage = () => {
          ...
          {users.map(user => (
            <tr key={user.userID} style={{ borderBottom: '1px solid black' }}>
              ...
              <td style={{ padding: '10px', textAlign: 'left' }}>
                <button style={{ backgroundColor: '#871A99', color: 'white', border: 'none', padding: '5px 10px', borderRadius: '5px' }} onClick={() => handleDelete(user.userID)}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
