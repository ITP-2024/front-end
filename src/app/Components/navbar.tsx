      ...
      <nav className="mt-[200px]">
        {navItems.map((item, index) => (
          <a key={index} href={item.href}>
            <div className="block w-full h-[52px] bg-purple-400  flex items-center justify-between pl-8 pr-4 border border-solid border-white-500 border-solid border-gray-300 hover:bg-fuchsia-800 mt-1 text-black hover:text-white ">
              {item.title}
              <svg
                className="w-3.5 h-2.5 mt-2 "
                aria-hidden="true"
