...
const Cart: React.FC<CartProps> = ({ icon, title, value }) => {
  return (
    <div className="w-[317px] h-[155px] relative">
      ...
      <div className="left-[13px]  absolute text-black text-[22px] font-semibold font-['Inter']">
        {icon}
      </div>
      <div className="left-[13px] top-[44px] absolute text-black text-[22px] font-semibold font-['Inter']">
        {title}
      </div>
      <div className="left-[13px] top-[88px] absolute text-black text-2xl font-semibold font-['Inter']">
        {value}
      </div>
    </div>
  );
