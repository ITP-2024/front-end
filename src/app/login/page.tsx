      ...
      <nav className="mt-[200px]">
        {navItems.map((item, index) => (
          <Link key={index} href={item.href}>
            <div className="block w-full h-[52px] bg-purple-400  flex items-center justify-between pl-8 pr-4 font-semibold  border-solid border-gray-300 hover:bg-fuchsia-800 mt-1 text-black hover:text-white ">
              {item.title}
              <svg
