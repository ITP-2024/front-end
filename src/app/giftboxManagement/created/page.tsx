                            ...
                            <tbody>
                                {giftBoxes.map((giftBox) => (
                                    <tr key={giftBox.giftBoxId}>
                                        <td className="border border-white-400 p-2 bg-thistle text-stone-900">{giftBox.boxColor.color}</td>
                                        <td className="border border-white-400 p-2 bg-thistle text-stone-900">{giftBox.cardType.type}</td>
                                        <td className="border border-white-400 p-2 bg-thistle text-stone-900">{giftBox.message}</td>
                                        <td className="border border-white-400 p-2 bg-thistle text-stone-900">
